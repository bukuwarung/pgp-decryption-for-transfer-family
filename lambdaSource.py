          ...
          def lambda_handler(event, context):
              ...
              if (downloadStatus):
                  ...
                  if (encryptedStatus):
                      ...
                      gpg = gnupg.GPG(gnupghome='/tmp', gpgbinary='/opt/python/gpg', options=['--trust-model', 'always', '--yes', '--always-trust'])
                      ...
                      if (status.ok == True):
                          ...
                          updatedfilelocation = 'payments/danamon/DecryptedFiles/' + updatedfilename
                  ...
                  # Else, no need to decrypt.
                      ...
                      print("The uploaded file is not encrypted, no changes required.")
